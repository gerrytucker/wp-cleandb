...
if(isset($_POST['cleanup-rev'])) {
	$cleaneddb .= CleanDBPostRevisions();	
}
if(isset($_POST['cleanup-spam'])) {
	$cleaneddb .= CleanDBSpamComments();
}
if(isset($_POST['cleanup-unapproved'])) {
	$cleaneddb .= CleanDBUnapprovedComments();
}
if(isset($_POST['cleanup-tags'])) {
	$cleaneddb .= CleanDBUnusedTags();
}
if(isset($_POST['cleanup-postmeta'])) {
	$cleaneddb .= CleanDBUnusedPostMeta();
}
if(isset($_POST['cleanup-mysql'])) {
	$cleaneddb .= CleanDBUnusedMySQL();
}

# Function for cleaning up the post revisions
# Function for cleaning up the post revisions
function CleanDBPostRevisions() {
	global $wpdb; 
...
function CleanDBUnapprovedComments() {
	global $wpdb; 
...
function CleanDBUnusedPostMeta() {
	global $wpdb;
...
<?php if($cleaneddb <> '') { ?>
<div id="message" class="updated fade"><?php echo $cleaneddb; ?>
</div>
<?php } ?>
